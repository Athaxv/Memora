    ...
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex w-full max-w-[1200px] flex-col items-center px-6 pt-24 pb-32 text-center md:pt-32 lg:pt-36">
        ...
        <h1 className="max-w-5xl relative">
          <div className="relative inline-block text-[clamp(2.5rem,5vw,5.35rem)] italic leading-[0.95] tracking-[-0.01em] font-serif subpixel-antialiased text-[#fbbf9b] drop-shadow-[0_2px_24px_rgba(0,0,0,0.5)]">
            The AI-Powered
            {/* Sparkle icon */}
            <svg viewBox="0 0 24 24" fill="none" className="absolute -right-8 -top-3 h-8 w-8 text-[#fef2e4]/90 md:-right-12 md:-top-4 md:h-11 md:w-11 drop-shadow-[0_2px_8px_rgba(0,0,0,0.4)]">
          ...
          <span className="mt-1 block text-[clamp(2.5rem,5vw,5.15rem)] leading-[0.95] font-sans font-bold tracking-[-0.045em] subpixel-antialiased text-[#fef2e4] drop-shadow-[0_2px_28px_rgba(0,0,0,0.55)]">
            Second Brain
          </span>
        </h1>
        ...
        <div className="mt-10 flex flex-col items-center gap-5 sm:flex-row md:mt-12">
          ...
          >
            ...
            <span className="absolute inset-0 border border-[#fef2e4] bg-[#fef2e4]/95 backdrop-blur-sm transition-colors group-hover:bg-[#fff5e6]"></span>
          ...
          <Link
            href="/demo"
            className="group inline-flex items-center gap-1.5 px-4 py-3.5 text-[15px] font-medium text-[#fff0e1]/85 transition-colors hover:text-[#fef2e4]"
          >
            <span className="underline underline-offset-4 decoration-[#fff0e1]/30 group-hover:decoration-[#fef2e4]/60 transition-colors">See it in action</span>
