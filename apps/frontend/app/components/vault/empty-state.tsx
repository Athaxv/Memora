export function EmptyState() {
  return (
    <div className="mx-auto w-full max-w-[640px] py-20 text-center">
      ...
      <h2 className="text-[1rem] md:text-[1.15rem] font-bold text-[#111118] tracking-tight mb-2">
        Your vault is empty
      </h2>
      ...
      <div className="inline-flex items-center gap-2 text-[11px] font-bold text-zinc-400">
        <span>Press</span>
        <kbd className="border border-zinc-200 bg-white px-1.5 py-0.5 text-[10px] font-bold text-zinc-900">/</kbd>
